...
class TestCamera(unittest.TestCase):
    ...
    def test_to_from_json(self):
        ...
        image_points = [(1.234, 2.345), (3.234, 4.345), (5.678, 7.890), (9.012, 1.234)]
        ...
        assert reconstructed_camera_with_points.image_to_world is not None # silence linter
        ...
        for i in range(len(image_points)):
            self.assertAlmostEqual(reconstructed_image_points[i][0],
                                   image_points[i][0])
            self.assertAlmostEqual(reconstructed_image_points[i][1],
                                   image_points[i][1])
            self.assertAlmostEqual(reconstructed_world_points[i][0],
                                   world_points[i][0])
            self.assertAlmostEqual(reconstructed_world_points[i][1],
                                   world_points[i][1])
    ...
    def test_get_work_surface_image_basic(self):
        ...
        camera._image_data[100:400, 100:500] = [255, 255, 255]  # White rectangle
        ...
        self.assertEqual(aligned_image.shape, (output_size[1], output_size[0], 3))
