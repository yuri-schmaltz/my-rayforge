...
| **True 4th Axis Support**    | Full support for rotary axis - as 4th axis, or in axis replacement mode as common on hobby machines.     |
| **3D G-code Preview**        | Simulate toolpaths in 3D to verify the job before sending it to the machine.                             |
