...
# Generate a source-only changes file for PPA upload
# This looks at the parent dir for .dsc and .orig.tar.gz generated by buildpackage above
# and creates a specific changes file that excludes binaries (Launchpad builds binaries itself).
PKG_VER=$(dpkg-parsechangelog -S Version)
dpkg-genchanges -S -sa > "../rayforge_${PKG_VER}_source.changes"
