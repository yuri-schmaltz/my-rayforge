...
from .adaptive_clearing_widget import AdaptiveClearingSettingsWidget
...
PRODUCER_WIDGETS = {
    AdaptiveClearingProducer: AdaptiveClearingSettingsWidget,
...
__all__ = [
    "AdaptiveClearingSettingsWidget",
