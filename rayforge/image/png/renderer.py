...
class PngRenderer(Renderer):
    ...
    def _get_natural_size_internal(
        self, *, render_data: Optional[bytes]
    ...
    def get_natural_size(
        ...
        return self._get_natural_size_internal(render_data=workpiece.data)
    ...
    def get_natural_size_from_data(
        ...
        *,
        ...
        return self._get_natural_size_internal(render_data=render_data)
