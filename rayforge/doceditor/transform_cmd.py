...
def finalize_interactive_transform(
    ...
    """
    Finalizes an interactive transform by collecting all matrix changes from
    view elements and committing them to the data model in a single,
    undoable transaction.

    Args:
        history_manager: The document's history manager for transactions.
...
def nudge_items(
    ...
    """
    Moves a list of DocItems by a given delta in world coordinates, creating
    a single undoable transaction for the operation.

    Args:
        history_manager: The document's history manager.
