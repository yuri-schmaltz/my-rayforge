...
def home_machine(machine: "Machine"):
...
def frame_job(
    doc: "Doc", machine: "Machine", ops_generator: "OpsGenerator"
):
    """
...
def send_job(doc: "Doc", machine: "Machine", ops_generator: "OpsGenerator"):
    """
    Generates ops for the current document and sends the job to the machine.
...
def set_hold(machine: "Machine", is_requesting_hold: bool):
    """
...
def cancel_job(machine: "Machine"):
