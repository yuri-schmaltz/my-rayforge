...
from ..actions import action_extension_registry
...
def setup_sketch_page(main_window: "MainWindow") -> "SketchStudio":
    ...
    This function is called by MainWindow during initialization to set up
    the sketch editing page. All sketch-specific logic lives here.
    ...
    _sketch_mode_cmd = main_window.sketch_mode_cmd
