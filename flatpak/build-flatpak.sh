...
# python3 -m flatpak_pip_generator -r requirements.txt --yaml --ignore-pkg pyclipper,PyGObject --runtime='org.gnome.Sdk/49' --ignore-errors --output flatpak/python3-requirements
