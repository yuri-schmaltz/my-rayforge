...
- Irregular shapes around multiple objects (use [Shrink Wrap](shrink-wrap.md) instead)
- Cutting individual parts (use [Contour](contour.md) instead)
...
- **[Shrink Wrap](shrink-wrap.md)** - Efficient irregular boundaries
