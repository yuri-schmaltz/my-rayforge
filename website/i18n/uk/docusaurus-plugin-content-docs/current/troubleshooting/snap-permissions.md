...
На дистрибутивах на основі Debian ваш користувач повинен бути членом групи
`dialout`, навіть при використанні Snap-пакету. Без цього членства в групі ви
можете отримувати повідомлення AppArmor DENIED при спробі доступу до
послідовних портів.
