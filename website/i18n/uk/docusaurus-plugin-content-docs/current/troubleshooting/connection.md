...
Спочатку додайте свого користувача до групи `dialout` (необхідно для обох Snap
і не-Snap інсталяцій на більшості дистрибутивів на основі Debian):
...
Якщо ви використовуєте версію Snap, вам також потрібно надати дозволи на
послідовний порт:
...
Вашому користувачу потрібно бути в групі `dialout` (або `uucp` на деяких
дистрибутивах). Це необхідно для **обох Snap і не-Snap інсталяцій** на
дистрибутивах на основі Debian, щоб уникнути повідомлень AppArmor DENIED:
...
**Важливо:** Ви повинні вийти з системи та зайти знову (або перезавантажити)
щоб зміни групи набрали чинності.

**Додатково для Snap інсталяцій**, надайте доступ до послідовного порту
snap-пакету:
