...
Кожному шару можна призначити власну робочу систему координат незалежно.
Коли шару призначено WCS, операції цього шару позиціонуються відносно WCS шару,
а не глобального. Це означає, що ви можете:
...
- Поєднувати плоску та поворотну роботу в одному проєкті, кожну з
  власним початком координат

Щоб призначити WCS шару, відкрийте налаштування шару та використовуйте вибір WCS.
Кнопка швидкого редагування поруч із вибором дозволяє налаштувати зміщення,
не залишаючи діалогового вікна.

Шари без явного призначення WCS використовують глобально активний WCS
із випадаючого списку панелі інструментів.
...
- [Позиціонування заготовки](../features/workpiece-positioning) -
  Комплексний посібник з позиціонування
- [Панель керування](../ui/bottom-panel) - Ручне керування та управління WCS
