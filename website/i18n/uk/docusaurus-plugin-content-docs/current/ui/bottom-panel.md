...
3. **Вкладка G-code**: Перегляд згенерованого G-code з підсвічуванням синтаксису
4. **Вкладка консолі**: Інтерактивний термінал G-коду з підсвічуванням синтаксису
5. **Робоча система координат (WCS)**: Швидкий вибір WCS

![Нижня панель](/screenshots/bottom-panel.png)

## Доступ до нижньої панелі

Нижня панель завжди видима в нижній частині головного вікна. Вона може бути
переключена через:
...
Вкладка перегляду G-code дозволяє переглядати згенерований G-code безпосередньо
в нижній панелі, перемикаючись між нею та консоллю:

### Функції перегляду G-code

- **Підсвічування синтаксису**: Різні кольори для команд, параметрів та коментарів
- **Підсвічування рядків**: Підсвічування поточного рядка під час виконання
- **Автоматичне оновлення**: Вміст оновлюється автоматично при зміні G-code
